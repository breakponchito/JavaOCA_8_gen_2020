...
import com.cert.oca8.course.devdamunguia95.module14.Exception.practice1.utility.PlayerDatabase;
import com.cert.oca8.course.devdamunguia95.module14.Exception.practice1.utility.PlayerDatabaseException;
...
public class League {
    ...
    public Team[] createTeams(String teamName, int teamSize) throws PlayerDatabaseException {
